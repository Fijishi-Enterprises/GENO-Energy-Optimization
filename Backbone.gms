...
References
----------
[1] K. Nolde, M. Uhr, and M. Morari, СMedium term scheduling of a hydro-thermal
    system using stochastic model predictive control, Т Automatica, vol. 44,
    no. 6, pp. 1585Ц1594, Jun. 2008.

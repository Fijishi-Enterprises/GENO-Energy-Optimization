...
positive variable
          v_epsSlack1 "slack variable 1 for AUGMECON"
          v_epsSlack2 "slack variable 2 for AUGMECON"
;
...
q_obj ..
    ...
    + v_obj * 1.0e6 // Objective function valued in MEUR instead of EUR (or whatever monetary unit the data is in)

...
class Ui_SettingsForm(object):
    def setupUi(self, SettingsForm):
        ...
        SettingsForm.setMinimumSize(QtCore.QSize(500, 430))
        SettingsForm.setMaximumSize(QtCore.QSize(500, 430))
        ...
        self.gridLayout_2.addWidget(self.pushButton_browse_project_dir, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_project_dir_location, 4, 0, 1, 1)
        ...
        self.lineEdit_work_dir_location = QtWidgets.QLineEdit(self.groupBox_general)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_work_dir_location, 5, 0, 1, 1)
        self.pushButton_browse_work_dir = QtWidgets.QPushButton(self.groupBox_general)
        self.pushButton_browse_work_dir.setObjectName("pushButton_browse_work_dir")
        self.gridLayout_2.addWidget(self.pushButton_browse_work_dir, 5, 1, 1, 1)
        ...
        SettingsForm.setTabOrder(self.pushButton_browse_project_dir, self.pushButton_browse_work_dir)
        SettingsForm.setTabOrder(self.pushButton_browse_work_dir, self.checkBox_clear_flags)
    ...
    def retranslateUi(self, SettingsForm):
        ...
        self.pushButton_browse_project_dir.setToolTip(_translate("SettingsForm", "<html><head/><body><p>Select project directory</p></body></html>"))
        ...
        self.lineEdit_project_dir_location.setToolTip(_translate("SettingsForm", "<html><head/><body><p>Project directory location. Leave this empty to use default.</p></body></html>"))
        self.lineEdit_project_dir_location.setPlaceholderText(_translate("SettingsForm", "Project directory"))
        ...
        self.lineEdit_work_dir_location.setPlaceholderText(_translate("SettingsForm", "Work directory"))

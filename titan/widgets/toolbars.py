...
def make_clear_toolbar(ui):
    ...
    disable.triggered.connect(ui.enable_disable_setups)
    # Set stylesheet
    toolb.setStyleSheet(ICON_TOOLBAR_STYLESHEET)

...
sets t   scheduling periods (2hrs)
     u   generating units
;

parameter load(t) system load
          initlev(t) initial level of the oil storage tank
;

$gdxin 'input/fuel_input.gdx'
$load t
$load u
$loaddc load
$load initlev
...
execute_unload 'output/fuel_output.gdx',
    status
    poil
    others
    oil

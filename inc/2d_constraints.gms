...
q_conversionIncHR(suft(effIncHR(effGroup), unit, f, t))$ft(f, t) ..
    ...
    + sum(gnu_output(grid, node, unit),
        + sum (hr,
         v_gen_inc(grid, node, unit, hr, f, t) //   output of each heat rate segment

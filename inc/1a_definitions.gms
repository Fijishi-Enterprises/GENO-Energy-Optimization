...
param_unit "Set of possible data parameters for units" /
    ...
    startCost "Variable start-up costs for cold starts excluding fuel costs (€/subunit)"
    startCostWarm "Variable start-up costs for warm starts excluding fuel costs (€/subunit)"
    startCostHot "Variable start-up costs for hot starts excluding fuel costs (€/subunit)"
    startFuelCons "Consumption of start-up fuel per cold subunit started up (MWh_fuel/subunit)"
    startFuelConsWarm "Consumption of start-up fuel per warm subunit started up (MWh_fuel/subunit)"
    startFuelConsHot "Consumption of start-up fuel per hot subunit started up (MWh_fuel/subunit)"

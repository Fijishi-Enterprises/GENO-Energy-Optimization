...
$call gams Backbone.gms --run_title=flat --year=2022 --t_jump=168  --t_horizon=336   --input_file_gdx=inputDataAdjusted1.gdx  --plot=1  Suppress=1 lo=0
...
$call gams Backbone.gms --run_title=spot --year=2022 --t_jump=168  --t_horizon=336   --input_file_gdx=inputDataAdjusted1.gdx  --plot=1  Suppress=1 lo=0
